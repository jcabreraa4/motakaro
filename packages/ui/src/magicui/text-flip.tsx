...
const TextFlip = ({ children, as: ElementTag = 'p', className, textClassName, flipTextClassName, staggerDuration = 0.05, staggerFrom = 'first', transition = DEFAULT_TRANSITION, rotateDirection = 'right', ...props }: TextFlipProps) => {
  ...
  const handleHoverStart = useCallback(async () => {
    ...
    try {
      ...
      await animate('.text-3d-flip-char', { transform: rotationTransform } as never, {
        ...transition,
