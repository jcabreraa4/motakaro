    ...
    <FileTreeFolderContext.Provider value={folderContextValue}>
      ...
      >
        <div
          ...
          {...props}
        >
          <div className={cn('flex w-full items-center gap-1 rounded px-2 py-1 text-left transition-colors hover:bg-muted/50', isSelected && 'bg-muted')}>
            <CollapsibleTrigger
              render={
                <button
...
export const FileTreeFile = ({ path, name, icon, className, children, ...props }: FileTreeFileProps) => {
  ...
  return (
    <FileTreeFileContext.Provider value={fileContextValue}>
      <div
        className={cn('flex cursor-pointer items-center gap-1 rounded px-2 py-1 transition-colors hover:bg-muted/50', isSelected && 'bg-muted', className)}
        onClick={handleClick}
