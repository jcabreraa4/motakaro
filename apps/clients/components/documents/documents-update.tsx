...
export function DocumentsUpdate({ document, onSuccess, children }: DocumentsUpdateProps) {
  ...
  const [info, setInfo] = useState({ name: document.name, note: document.note, clientStarred: document.clientStarred.toString() });

  function handleUpdate() {
    updateDocument({ id: document._id, name: info.name, note: info.note, clientStarred: info.clientStarred === 'true' })
      .then(() => {
        setOpen(false);
  ...
  function handleReset() {
    setInfo({ name: document.name, note: document.note, clientStarred: document.clientStarred.toString() });
  }
