...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <main className="dark flex h-screen bg-[#0A0A0A]">
      <section className="relative flex h-svh w-full items-center justify-center p-5">
      ...
      <section className="pointer-events-none relative hidden h-svh w-full select-none xl:flex">
